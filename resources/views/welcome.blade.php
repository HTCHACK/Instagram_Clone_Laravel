                        ...
                        @if ($user == Auth::user())
                            <li class="list-group-item">
                                ...
                                {{ $user->name }}<a href="{{ route('home') }}" style="margin-left:0.2rem"
                                    ...
                                    style="margin-left:0.2rem" class="btn btn-info">View</a>
                            </li>
                        @else
                            <li class="list-group-item">
                                <a href="{{ route('users.show', $user->id) }}"><img width="50px" height="50px"
                                        style="border-radius:50%"
                                        src="{{ asset(str_replace('public', 'storage', $user->photo)) }}" alt="">
                                </a>
                                {{ $user->name }}
                                <a href="{{ route('users.show', $user->id) }}" style="margin-left:0.2rem"
                                    class="btn btn-warning">Follow
                                </a>
                                <a href="{{ route('users.show', $user->id) }}" style="margin-left:0.2rem"
